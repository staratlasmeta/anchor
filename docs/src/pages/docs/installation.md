...
Anchor binaries are available via an NPM package [`@staratlas/anchor-cli`](https://www.npmjs.com/package/@staratlas/anchor-cli). Only `x86_64` Linux is supported currently, you must build from source for other OS'.
