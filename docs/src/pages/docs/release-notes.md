...
- cli: Add fields `os` and `cpu` to npm package `@staratlas/anchor-cli` ([#976](https://github.com/coral-xyz/anchor/pull/976)).
...
- ts: `@staratlas/anchor` package for generating TypeScript clients.
